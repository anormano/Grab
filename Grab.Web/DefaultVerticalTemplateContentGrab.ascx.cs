...
namespace Grab.Web
{
    public partial class DefaultVerticalTemplateContentGrab : TemplateContent, IXafPopupWindowControlContainer, IXafSecurityActionContainerHolder, IHeaderImageControlContainer
    {
        static DefaultVerticalTemplateContentGrab()
        {
