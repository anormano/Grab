...
<%@ Control Language="C#" CodeBehind="DefaultVerticalTemplateContentGrab.ascx.cs" ClassName="DefaultVerticalTemplateContentGrab" Inherits="Grab.Web.DefaultVerticalTemplateContentGrab" %>
